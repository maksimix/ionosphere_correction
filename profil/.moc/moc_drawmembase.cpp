...
#include "../../draw_qt4/drawmembase.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DrawMemBase_t, stringdata) + ofs \
...
void *DrawMemBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DrawMemBase.stringdata))
