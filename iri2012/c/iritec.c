...
struct {
    real y05, h05top, qf, xnetop, xm3000, hhalf, tau;
} qtop_;
...
logical *jf;
integer *iy, *md;
real *hour, *hbeg, *hend, *tec, *tecb, *tect;
{
    static real aend, oarr[100], astp, outf[20000]	/* was [20][1000] */;
...
real *tectot, *tectop, *tecbot;
{
    ...
    static integer ia;
    static real hh, hr[6], hu, hx, sumbot, x_2__, x_3__, x_4__, ht1, ht2, 
	    x_5__, sumtop, del_hei__, hei_end__, hht, yne, hss, xkk, 
	    hei_top__, top_end__, ed_2__, ed_3__, ed_4__, ed_5__, xxx, yyy;
    extern doublereal xe_1__();
    static real zzz, ss_2__, ss_3__, ss_4__;
    static integer numstep;
    static real xne1, xne2;
...
/* NEW-GUL: interpolate for htop */
    if (hx <= block1_1.hmf2 || hht > (float)0.) {
	goto L4;
    }
