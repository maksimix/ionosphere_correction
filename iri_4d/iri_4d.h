...
class IRI_3D: private SPCUB3
{
  public:
    ...
    void resetProfil();
    void ioncorrTec(double lat, double lon, double time, double h_tec, double &tec, double &tec_top, double &w, double &ig, int jf);
...
extern IRI_3D **iri_4dbase;
extern int iri_NTime;
extern double *iri_tTime;
#endif  //iri_3d.hpp
