...
extern double alfa0,beta0,aX,aY,aZ,delta0,r_0,teta_0,fi_0,rx_0,ry_0,rz_0,kx_0[3],ky_0[3],kz_0[3];
extern double fplIon[MaxSion][MaxHion],dsIon,dhIon,hminIon,fmaxIon;
extern double sMinIon,sMaxIon,alfIon;
extern double RMax;
extern double fi_m0,teta_m0,ro_m,lambd1,lambd2,lambd3,lambd4,lambd5,amp_proval,amp_proval1,fi0_inv,steta_m0,cteta_m0;
