...
c        WRITE (6,*)'jf(8) -------- >>', jf(8)
c        WRITE (6,*)'jf(9) -------- >>', jf(9)
c        WRITE (6,*)'jf(20) -------- >>', jf(20)
c        WRITE (6,*)'jf(21) -------- >>', jf(21)
c        WRITE (6,*)'jf(22) -------- >>', jf(22)
c        WRITE (6,*)'jf(23) -------- >>', jf(23)
c        WRITE (6,*)'jf(24) -------- >>', jf(24)
c        WRITE (6,*)'jf(25) -------- >>', jf(25)
c        WRITE (6,*)'jf(26) -------- >>', jf(26)
c        WRITE (6,*)'jf(27) -------- >>', jf(27)
c         WRITE (6,*)'fstorm_on -------- >>', fstorm_on
        if(fstorm_on.and.(indap(1).gt.-1)) then    
            icoord=1
            kut=int(hourut)
c            WRITE (6,*)'hourut  -------- >>', hourut
