...
class DrawPointRect : public DrawBase
{
  public:
    ...
    void setXY(double x, double y, QColor c, double h, double w, long n);
    ...
    void reset();
    QPtrList <PointDouble>  *getListPointDouble(){return pointDouble;};
    long getKol(){return kol;};
  private:
    long   kol;
    QPtrList <PointDouble>  *pointDouble;
    bool keyClear;
