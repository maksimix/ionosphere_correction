          ...
          if ((d6=zero_t(d2,f2,d3,f3,s0,alfa,ihop,delt,eps,ep,ep1,e,eps1,epsa,aa0,putdat+ihop*n))>=.0)
            {
              ...
              if (keysol>0)
              {
                  ...
                  //    printf("\n2 kk=%2d  d6=%6.3f d6=%6.3f d7=%6.3f  s=%8.3f Alf1=%8.3f Alf2=%8.3f eps=%12.5e ep=%12.5e ep1=%12.5e e=%12.5e",
                  //           kk+1,d6/RAD,D1(ihop*n+kk),D2(ihop*n+kk),S(ihop*n+kk),A1(ihop*n+kk),A2(ihop*n+kk),eps,ep,ep1,e);
