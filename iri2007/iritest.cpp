/* iritest.f -- translated by f2c (version 20061008).
...
.2,1pe9.2,1pe9.2,1pe9.2)";
    ...
    static char fmt_7117[] = "(f6.1,f10.1,1x,f6.3,3i6,7i4,f6.1,i4)";
    ...
    /* Local variables */
    static doublereal htec_max__;
    static integer i__, j, icontinue;
    static logical jf[30];
    static integer ij, li, jm;
    static doublereal hx;
    static integer iy, ih1, ih2, ip1, ip2;
    ...
    static char bopt[8];
    static doublereal xlat;
    static integer numi;
    static char iopt[10];
    static doublereal xcor, outf[10000]	/* was [20][500] */, hour, xner, xlon;
    static char sopt[3], topt[9], xtex[4];
    static doublereal vstp;
    static char f1opt[16], pname[9*6];
    static integer itopp;
    static doublereal piktab;
    static integer numstp, jchoice;
    extern /* Subroutine */ int iri_web__(integer *, logical *, doublereal *, 
...
/* normal output */
	...
	ajne = (doublereal) ((integer) (outf[li * 20 - 20] / 1e6 + .5));
	...
	s_wsfe(&io___224);
	do_fio(&c__1, (char *)&xcor, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&ajne, (ftnlen)sizeof(doublereal));
