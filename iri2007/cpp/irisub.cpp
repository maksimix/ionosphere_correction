/* irisub.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int iri_sub__(logical *jf, integer *jmag, doublereal *alati, 
	doublereal *along, integer *iyyyy, integer *mmdd, doublereal *dhour, 
...
.\002)";
    ...
    double cos(doublereal), pow_dd(doublereal *, doublereal *), d_sign(
	    doublereal *, doublereal *);

    /* Local variables */
    static logical sam_date__;
    extern /* Subroutine */ int igrf_dip__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), igrf_sub__(doublereal *, doublereal *, doublereal *
	    , doublereal *, doublereal *, integer *, doublereal *, doublereal 
	    *), apf_only__(integer *, integer *, integer *, doublereal *);
    static logical f1_l_cond__;
    static doublereal d__, f[3];
    static integer i__, j, k, l;
    static doublereal x, y, z__, f2[1976]	/* was [13][76][2] */, r2, x1,
	     z1, z2, z3;
    extern /* Subroutine */ int f00_(doublereal *, doublereal *, integer *, 
    ...
    extern doublereal ti_(doublereal *);
    ...
    extern /* Subroutine */ int apf_(integer *, integer *, integer *, 
	    doublereal *, integer *);
    static integer kut;
    static doublereal ttt, flu;
    extern /* Subroutine */ int tal_(doublereal *, doublereal *, doublereal *,
	     doublereal *, logical *, doublereal *);
    static doublereal xdx, vkp, f107d;
    extern doublereal b0_98__(doublereal *, doublereal *, doublereal *, 
    ...
    extern doublereal f1_c1__(doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    ...
    extern /* Subroutine */ int soco_(integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal zm3000, rzar[3], hour;
    static logical topo, rzin;
    extern doublereal fout_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    ...
    extern /* Subroutine */ int teba_(doublereal *, doublereal *, integer *, 
	    doublereal *);
    static doublereal dimo, dipl, sdte;
    extern doublereal tede_(doublereal *, doublereal *, doublereal *);
    static doublereal stte1, stte2, bcoef;
    extern doublereal elte_(doublereal *);
    ...
    extern doublereal teder_(doublereal *);
    ...
    extern /* Subroutine */ int rogul_(integer *, doublereal *, doublereal *, 
	    doublereal *);
    static doublereal width, depth;
    extern doublereal xmded_(doublereal *, doublereal *, doublereal *);
    static doublereal xnehz;
    extern /* Subroutine */ int cira86_(integer *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal secni;
    static logical rzino;
    extern /* Subroutine */ int ut_lt__(integer *, doublereal *, doublereal *,
	     doublereal *, integer *, integer *), storm_(integer *, 
	    doublereal *, doublereal *, integer *, doublereal *, integer *, 
	    integer *, doublereal *);
    extern doublereal hmf2ed_(doublereal *, doublereal *, doublereal *, 
	    doublereal *), fof1ed_(doublereal *, doublereal *, doublereal *);
    extern /* Subroutine */ int regfa1_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, D_fp, 
	    logical *, doublereal *);
    static doublereal texni, signi, tlbdn, hmaxd;
    extern doublereal xmout_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    ...
    extern /* Subroutine */ int koefp1_(doublereal *), koefp2_(doublereal *), 
	    koefp3_(doublereal *);
    static doublereal sunde1;
    extern /* Subroutine */ int sufe_(doublereal *, doublereal *, integer *, 
	    doublereal *);
    static doublereal zzz1;
    static integer msumo;
    static doublereal ho05, hfixo, delx, ymaxx;
    extern doublereal rpid_(doublereal *, doublereal *, doublereal *, integer 
	    *, doublereal *, integer *, doublereal *);
    static doublereal yo2h0o, yoh0o;
    static logical ursif2;
    static doublereal hfixo2, rdo2mx, ymo2z, aldo21, xhmf1, elede;
    extern doublereal xen_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, doublereal *, doublereal *)
	    , xe_1__(doublereal *);
    static doublereal dipl1, babs1;
    extern /* Subroutine */ int calne_(integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, integer *, doublereal *, doublereal *);
    static doublereal tnh, tih, teh;
    extern /* Subroutine */ int fieldg_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *);
    extern doublereal foeedi_(doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static doublereal rox, rhx, rnx, rhex, dndhbr, hefold, rnox, ro2x;
    extern /* Subroutine */ int rdhhe_(doublereal *, doublereal *, doublereal 
	    *, doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static integer seaday;
    static char filnam[12];
    static integer icalls;
    extern /* Subroutine */ int geodip_(integer *, doublereal *, doublereal *,
    ...
    extern /* Subroutine */ int inilay_(logical *, logical *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
    ...
    extern /* Subroutine */ int elteik_(integer *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, doublereal *,
	     doublereal *, doublereal *);
    static doublereal tnahhi, rdomax;
    extern doublereal epstep_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal height, rclust;
    extern doublereal rdno_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal xnorm, edens;
    static integer ierror;
    static doublereal drift;
    extern /* Subroutine */ int vdrift_(doublereal *, doublereal *, 
	    doublereal *, doublereal *);
    static doublereal daynr1;
    extern /* Subroutine */ int f1_prob__(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *), spreadf_brazil__(
	    integer *, integer *, doublereal *, doublereal *, doublereal *);
    static integer ispf;
    static logical sam_yea__;
    static doublereal spreadf;
    extern /* Subroutine */ int dregion_(doublereal *, integer *, doublereal *
	    , doublereal *, doublereal *, doublereal *, doublereal *);
    static logical sam_mon__, sam_doy__;
    static integer iseamon;
    extern /* Subroutine */ int ioncomp_(doublereal *, integer *, integer *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
...
L9245:
    ...
    regfa1_(&block4_1.hef, &block1_1.hmf2, &xe2h, &block1_1.nmf2, &c_b166, &
	    nmf1, (D_fp)xe2_, &schalt, &block1_1.hmf1);
    if (! schalt) {
	goto L3801;
    }
...
L380:
    ...
    regfa1_(&hf1, &hf2, &xf1, &xf2, &c_b166, &block4_1.nme, (D_fp)xe3_1__, &
	    schalt, &block3_1.hst);
    if (schalt) {
	goto L3885;
    }
...
/* Tangent on Tn profile determines HS */
    ti13 = teder_(&c_b209);
    ti50 = teder_(&c_b74);
    regfa1_(&c_b209, &c_b74, &ti13, &ti50, &c_b213, &ti1, (D_fp)teder_, &
	    schalt, &block8_1.hs);
    if (schalt) {
	block8_1.hs = 200.;
    }
...
/* Subroutine */ int iri_web__(integer *jmag, logical *jf, doublereal *alati, 
	doublereal *along, integer *iyyyy, integer *mmdd, integer *iut, 
	doublereal *dhour, doublereal *height, doublereal *h_tec_max__, 
	integer *ivar, doublereal *vbeg, doublereal *vend, doublereal *vstp, 
	doublereal *a, doublereal *b)
{
    ...
    extern /* Subroutine */ int iri_tec__(doublereal *, doublereal *, integer 
	    *, doublereal *, doublereal *, doublereal *), iri_sub__(logical *,
