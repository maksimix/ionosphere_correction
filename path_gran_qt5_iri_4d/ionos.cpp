...
/***************************************************************/
{
   double rd[3],rexp,r1,g,r2,r3,r4,drtf[3],g2,dr,df,dt,
...
/*--------------------------------------------------------------*/
   ...
   if (r<h0)
   {
       ...
       if (mod<10)
       {
           ...
           g=1.+r1*dfIon+gy*dtIon;
           g2=g*g;

           /*
           r1=gx*st;
           r4=r1*dfIon+gy*dtIon;
           r3=gx*ct*dfIon+gy;
           g=tanh(r4);
           g2=1+g;
           ...
           */
           if (n>8)
           {
               ...
               vpp[2][2]=vpp[2][2]*g2;
               /*
               vpp[0][0]=-v*2.*sh*r1*r1/(ch2*ch);
               vpp[0][1]=-v*2.*sh*r1*r3/(ch2*ch)+gx*ct/ch2;
               vpp[0][2]=vp[2]*r1/ch2;
               vpp[1][0]=vpp[0][1];
               vpp[1][1]=-v*2.*sh*r3*r3/(ch*ch2)-r1*dfIon/ch2;
               vpp[1][2]=vp[2]*r3/ch2;
               vpp[2][0]=vpp[0][2];
               vpp[2][1]=vpp[1][2];
               vpp[2][2]=vpp[2][2]*g2;
