/* iritec.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int irit13_(doublereal *alati, doublereal *along, integer *
	jmag, logical *jf, integer *iy, integer *md, doublereal *hour, 
	doublereal *hbeg, doublereal *hend, doublereal *tec, doublereal *tecb,
	 doublereal *tect)
{
    static doublereal abeg, aend, oarr[50], astp, outf[10000]	/* was [20][
	    500] */;
...
doublereal ioncorr_(doublereal *tec, doublereal *f)
{
...
/* ----------------------------------------------------------------------- */
    ret_val = *tec * 40.3 / (*f * *f);
    return ret_val;
} /* ioncorr_ */



/* Subroutine */ int iri_tec__(doublereal *hstart, doublereal *hend, integer *
	istep, doublereal *tectot, doublereal *tectop, doublereal *tecbot)
{
    /* Builtin functions */
    ...
    static doublereal hh, hr[6], hu, hx, x_2__, x_3__, x_4__, x_5__, yne, hss,
	     xkk, ed_2__, ed_3__, ed_4__, ed_5__, yyy;
    extern doublereal xe_1__(doublereal *);
    static doublereal zzz, ss_2__, ss_3__, ss_4__, delx, ss_t__;
    static logical expo;
    static doublereal step[5], hei_2__, hei_3__, hei_4__, hei_5__, xnorm, 
	    xntop, sumbot, sumtop, del_hei__, hei_end__, hei_top__, top_end__;
...
/* test */
    expo = FALSE_;
    numstep = 5;
    xnorm = block1_1.xnmf2 / 1e3;
    hr[0] = 100.;
    hr[1] = block1_1.hmf2 - 10.;
    hr[2] = block1_1.hmf2 + 10.;
    hr[3] = block1_1.hmf2 + 150.;
    hr[4] = block1_1.hmf2 + 250.;
    hr[5] = *hend;
    for (i__ = 2; i__ <= 6; ++i__) {
/* L2918: */
	if (hr[i__ - 1] > *hend) {
