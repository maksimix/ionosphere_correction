C I am forwarding to you the latest version of the MSIS model for your
C analysis work. I would appreciate your bringing any problems you might
C discover to my attention.  I would also appreciate hearing about your 
C results using this model.
C
C Alan E. Hedin, 10/9/90
C PACF::HEDIN
C (301)-286-8393
C
C Contents:  MSIS FORTRAN SUBROUTINE GTD6
C            FORTRAN TEST DRIVER
C            OUTPUT OF TEST

C ==================================================================
C Version: 22-JUL-1991 15:59:42.72 
C
C This version includes SAVE statements and new driver and test data. 
C
C NOTE: This model is NOT an upgrade for the upper thermosphere and is 
C       probably less efficient than MSIS86.
C ==================================================================
C Version: 10-MAR-1993 15:31:11.76 
C
C Changing to density per cubic meter instead of per cubic centimeter
C did under certain particular conditions result in erroneous density
C by less than a percent (wrong entry name) when first (and only
C first) calling subroutine GTD6. This was corrected.
C
C==================================================================
C
C Contents:  MSIS FORTRAN SUBROUTINE GTD6
...
C       Upper Thermosphere Parameters
     ...
     $ DAY,DF,DFA,APD,APDF,APT(4),XLONG,CLONG,SLONG,IYR
      SAVE
...
C      VERSION OF GLOBE FOR LOWER ATMOSPHERE 1/17/90
      REAL LONG
      COMMON/LPOLY/PLG(9,4),CTLOC,STLOC,C2TLOC,S2TLOC,C3TLOC,S3TLOC,
     $ DAY,DF,DFA,APD,APDF,APT(4),LONG,CLONG,SLONG,IYR
      COMMON/CSW/SW(25),SWC(25),ISW
