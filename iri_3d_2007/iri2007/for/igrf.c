...
/* Subroutine */ int igrf_sub__(xlat, xlong, year, height, xl, icode, dipl, 
	babs)
doublereal *xlat, *xlong, *year, *height, *xl;
integer *icode;
doublereal *dipl, *babs;
{
    /* Builtin functions */
    double sqrt(), atan();

    /* Local variables */
    static doublereal lati, dimo;
...
/* Subroutine */ int igrf_dip__(xlat, xlong, year, height, dip, dipl, ymodip)
doublereal *xlat, *xlong, *year, *height, *dip, *dipl, *ymodip;
{
    /* Builtin functions */
    double asin(), cos(), sqrt(), d_sign(), atan();

    /* Local variables */
    static doublereal babs, dimo, h__;
    extern /* Subroutine */ int feldg_();
...
doublereal *bequ, *rr0;
{
    ...
    /* Local variables */
    static doublereal bold, bmin, rold, step;
    static integer irun;
    static doublereal b;
    static integer i__, j, n;
    static doublereal p[32]	/* was [8][4] */, step12;
    extern /* Subroutine */ int stoer_();
    static doublereal r1, r2, r3, bdelta, zz, bq1, bq2, bq3;
...
int n__;
doublereal *glat, *glon, *alt, *dimo, *fl;
integer *icode;
doublereal *b0, *v;
{
    /* Initialized data */
    ...
    /* Builtin functions */
    double sin(), cos(), sqrt(), d_sign(), log(), exp();

    /* Local variables */
    static doublereal bequ, rlat;
    static integer iequ;
    static doublereal term, rlon, step2, d__;
    static integer i__, n;
    static doublereal p[800]	/* was [8][100] */, r__, t, z__, radik, 
	    step12, c0, c1, c2, oterm, c3, d0, d1, d2, e0;
    extern /* Subroutine */ int stoer_();
    static doublereal e1, e2, r1, r2, r3, dimob0, ff, gg, fi, ct, rq, st, 
	    oradik, zq, xx, zz, bq1, bq2, bq3, r3h, hli, stp, arg1, arg2;
...
doublereal *p, *bq, *r__;
{
    ...
    static doublereal dr, dx, dy, dz, rq, xm, ym, zm, wr, fli, dsq, dxm, dym, 
	    dzm;
...
/* Subroutine */ int feldg_0_(n__, glat, glon, alt, bnorth, beast, bdown, 
	babs, v, b)
int n__;
doublereal *glat, *glon, *alt, *bnorth, *beast, *bdown, *babs, *v, *b;
{
    /* System generated locals */
    integer i__1;
    ...
    /* Local variables */
    static doublereal brho;
    static integer imax;
    static doublereal rlat;
    static integer last;
    static doublereal rlon, bxxx, byyy, bzzz, d__, f;
    ...
    static integer is;
    static doublereal sp, rq, st, rho, xxx, yyy, zzz;
...
doublereal *glat, *glon, *alt, *bnorth, *beast, *bdown, *babs;
{
...
integer *iyr;
doublereal *sla, *slo, *dla, *dlo;
integer *j;
{
    static doublereal r__, x, y, z__, pf, th;
    extern /* Subroutine */ int geomag_();
    static doublereal rm, xm, ym, zm;
    extern /* Subroutine */ int sphcar_();
    static doublereal dco, col, sco, rlo, szm;
...
doublereal *r__, *teta, *phi, *x, *y, *z__;
integer *j;
{
    /* System generated locals */
    doublereal d__1, d__2;
...
doublereal *xgeo, *ygeo, *zgeo, *xmag, *ymag, *zmag;
integer *j, *iyr;
{
    /* Initialized data */
