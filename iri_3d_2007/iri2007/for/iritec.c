/* iritec.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int irit13_(alati, along, jmag, jf, iy, md, hour, hbeg, hend,
	 tec, tecb, tect)
doublereal *alati, *along;
integer *jmag;
logical *jf;
integer *iy, *md;
doublereal *hour, *hbeg, *hend, *tec, *tecb, *tect;
{
    static doublereal aend, oarr[50], astp, outf[10000]	/* was [20][500] */;
    extern /* Subroutine */ int iri_tec__(), iri_sub__();
    static doublereal abeg;
...
/* Subroutine */ int iri_tec__(hstart, hend, istep, tectot, tectop, tecbot)
doublereal *hstart, *hend;
integer *istep;
doublereal *tectot, *tectop, *tecbot;
{
    /* Builtin functions */
    double exp(), log();

    /* Local variables */
    static doublereal delx, ss_t__;
    static logical expo;
    static doublereal step[5], hei_2__, hei_3__, hei_4__, hei_5__;
    static integer num_step__;
    static doublereal h__;
    static integer i__;
    static doublereal xnorm, xntop;
    static integer ia;
    static doublereal hh, hr[6], hu, hx, sumbot, x_2__, x_3__, x_4__, x_5__, 
	    sumtop, del_hei__, hei_end__, yne, hss, xkk, hei_top__, top_end__,
	     ed_2__, ed_3__, ed_4__, ed_5__, yyy;
    extern doublereal xe_1__();
    static doublereal zzz, ss_2__, ss_3__, ss_4__;
