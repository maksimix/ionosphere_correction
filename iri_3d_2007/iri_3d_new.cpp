...
int gtd6_(int *iyd, float *sec, float *alt,
	    float *glat, float *glong, float *stl, float *
            f107a, float *f107, float *ap, int *mass,
            float * d__, float *t);
};
  ...
  for(i=0; i<nx; i++)
  {
    ...
    */
          ...
          for(alt=zMin,l=0; alt<zMax && l<nz; alt+=dz_f, l++)
          {
              ...
              gtd6_(&imd,&sec,&alt,&lat_f,&lon_f,&hour_stl,&f107a,&f107,&ap[0],&mass,&d__[0],&t[0]);
