...
private:
    Q3CanvasRectangle *fildDiagramm; // закрашенное поле графика
    Q3CanvasRectangle      *lineFild;     // поле под графиком
    Q3CanvasRectangle      *lineMarkFild[MaxKolMarkFild]; // отмеченная область
    Q3CanvasRectangle      *lineSelectFild; // выделяемая область
