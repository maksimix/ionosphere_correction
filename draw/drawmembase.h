...
public:
    ...
    void setColorFon(QColor c){colorFon=c;};
...
class DrawMemBase: public WIDGET
{
  ...
  public:
    ...
    void setColorFon(QColor col){colorFon=col; marker->setColorFon(col);};
    ...
    void   setFlagResize(bool b){flagResize=b;};
    bool   getFlagResize(){return flagResize;};
...
signals:
    ...
    void signalPressMouse(long, Qt::MouseButton);
