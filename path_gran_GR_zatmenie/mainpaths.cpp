    ...
    { /* t */
      ...
      if (keyZat)
      {
          ...
          if (iZ>=0)
          {
              ...
              double cAlfa0,sAlfa0,cBeta0,sBeta0;
      ...
      if (keyZat)
          fprintf(out,"\n1 t=%f lat_0=%f  fi_0=%f  delta0=%f  lonCzat[i]=%f\n",tZ/3600.,90.-teta_0/RAD,fi_0/RAD,delta0,lonCzat[iZ]);
