...
void DrawBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DrawBase::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawBase::signalRealValue)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DrawBase::*)(double , double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawBase::signalRealValue)) {
                *result = 1;
                return;
            }
        ...
        {
            using _t = void (DrawBase::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawBase::signalClear)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DrawBase::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawBase.data,
      qt_meta_data_DrawBase,  qt_static_metacall, nullptr, nullptr}
};
