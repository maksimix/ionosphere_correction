...
void DrawMemBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DrawMemBase::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalRealValue)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DrawMemBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalResetMarkFild)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DrawMemBase::*)(int , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalChangeMarkFild)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (DrawMemBase::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalChangeSelectFild)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (DrawMemBase::*)(long , Qt::MouseButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalPressMouse)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (DrawMemBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalResetSelectFild)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (DrawMemBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawMemBase::signalReleaseMouseMid)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DrawMemBase::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DrawMemBase.data,
      qt_meta_data_DrawMemBase,  qt_static_metacall, nullptr, nullptr}
};
