...
typedef struct
{
    ...
    double standardDeviationAzim;           //
    double averageDist;                     //
    double averageAzim;                     //
    double averageAngle;                    //
    double relativeErrorD=0;                  //
    double relativeErrorAz=0;                 //
    double absoluteErrorD=0;                  //
    double absoluteErrorAz =0;                 //
...
//double standardDeviation(double* arr, int argc, double realVal);
double standardDeviation(double *arr, int countArrEl);
double standardDeviation(double* arr, int countArrEl, double realVal);
void modeDistributor(double val, int en,  double **arrE, double **arrF1,double **arrF2,unsigned long modaVal,int wox);
