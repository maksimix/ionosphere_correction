...
/**************************************************************/
/*                                                            */
/*     ОСУЩЕСТВЛЯЕТ ПЕРЕВОД ВЕКТОРА Х ИЗ ДЕКАРТОВОЙ С/К       */
/*      В СФЕРИЧЕСКУЮ, ЕСЛИ i=1, И ОБРАТНОЕ ПРЕОБРАЗОВНИЕЯ    */
/*      В ОСТАЛЬНЫХ СЛУЧАЯХ.                                  */
/*                                                            */
/*VGG                                                         */
/**************************************************************/
{
  ...
  switch (i)
    {
      case 1:  /* ПРЕОБРАЗОВАНИЕ В СФЕРИЧЕСКУЮ С/К */
	     y[0]=-sf*x[0]+cf*x[1];
      ...
      case 2: /*  ПРЕОБРАЗОВАНИЕ В ДЕКАРТОВУ С/К */
