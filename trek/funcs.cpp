...
int MyTrek::func(double x,
                 double *y,
                 double *f,
                 int    n)
/*******************************************************************/
/*                                                                 */
/* СФЕРИЧЕСКИЙ ВАРИАНТ ПРОГРАММЫ ПОСТРОЕНИЯ ЛУЧЕВОЙ ТРАЕКТОРИИ     */
/*                                                                 */
/* ФУНКЦИЯ ВЫЧИСЛЯЕТ ЗНАЧЕНИЯ ПРАВЫХ ЧАСТЕЙ ДИФФ. УРАВНЕНИЙ ЛУЧА   */
/*                                                                 */
/* x  - независимая переменная;                                    */
/* *y - набор лучевых функций;                                     */
/* *f - значения правых частей дифф. уравнений луча.               */
/*                                                                 */
/*VGG                                                              */
/*******************************************************************/
{
  ...
  if (ivar)    /* МОДЕЛЬ ГЛОБАЛЬНОГО ГЕОМАГНИТНОГО ПОЛЯ */
  {
  ...
  if (n>8)
  {
      /* ЧАСТЬ, СООТВЕТСТВУЮЩАЯ УРАВНЕНИЯМ ДЛЯ ПРОИЗВОДНЫХ  */
      /* ФАЗОВЫХ КООРДИНАТ ПО ЛОКАЛЬНЫМ ЛУЧЕВЫМ КООРДИНАТАМ */
