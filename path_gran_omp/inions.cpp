...
/***************************************************************/
{
  ...
  int    i,npoint,key;
  GRAN   gran;
  double *hpl=mytrek_ext->getHpl();
  double *fpl=mytrek_ext->getFpl();
  double &v=mytrek_ext->getV();
  double &par=mytrek_ext->getPar();
  ...
  else
  {
      ...
      */
      ...
      //mytrek_ext->iri_3dbase =new IRI_3D(*::iri_3dbase);
      //mytrek_ext->iri_3dbase2=new IRI_3D(*::iri_3dbase2);
      mytrek_ext->copy_iri_model();
  }
  ...
  for(i=0; i<npoint; i++)
  {
      ...
      mytrek_ext->ionos(fi0,teta0,hpl[i],6);
